...
export const insertLaboratoryWorkSchema = createInsertSchema(laboratoryWorks).omit(timestamps);
export const insertLaboratoryWorkParams = baseSchema.extend({
...
export type UpdateLaboratoryWorkParams = z.infer<typeof updateLaboratoryWorkParams>;
...
export type CompleteLaboratoryWork = Awaited<ReturnType<typeof getLaboratoryWorks>>["laboratoryWorks"][number];
