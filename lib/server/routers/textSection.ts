import { getTextSectionById, getTextSection } from "@/lib/api/textSection/queries";
...
import { createTextSection, deleteTextSection, updateTextSection } from "@/lib/api/textSection/mutations";

export const textSectionRouter = router({
  getTextSection: publicProcedure.query(async () => {
    return getTextSection();
  }),
  getTextSectionById: publicProcedure.input(textSectionIdSchema).query(async ({ input }) => {
