    ...
    <Dialog onOpenChange={setOpen} open={open}>
      ...
      <DialogContent>
        <DialogHeader className="px-5 pt-5">
          <DialogTitle>{ editing ? "Edit" : "Create" } Submitted Laboratory Work</DialogTitle>
        </DialogHeader>
        <div className="px-5 pb-5">
          <SubmittedLaboratoryWorkForm closeModal={closeModal} submittedLaboratoryWork={submittedLaboratoryWork} />
        </div>
      </DialogContent>
    </Dialog>
  );
