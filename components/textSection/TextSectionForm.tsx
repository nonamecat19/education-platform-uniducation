...
import { TextSection, NewTextSectionParams, insertTextSectionParams } from "@/lib/db/schema/textSection";
                ...
                >
                  ...
                  <SelectContent>
                    {units?.units.map((unit) => (
                      <SelectItem key={unit.unit.id} value={unit.unit.id.toString()}>
                        {unit.unit.id}  {/* TODO: Replace with a field from the unit model */}
                      </SelectItem>
                    ))}
                  </SelectContent>
                </Select>
